...
| `Rls:Enforce` | admin-api, content-api, site-host, media-worker, ai-gateway | `true` on media-worker, set beside its `dcms_app` connection string; `false` elsewhere until ADR 0015 phase 4 moves each service |
