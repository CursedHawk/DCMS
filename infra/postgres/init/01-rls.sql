...
GRANT USAGE ON SCHEMA tenancy, plugins, cms, media, sites, search, analytics, chat, visitors, ai TO dcms_rls;

-- Future tables (created by EF migrations) become readable by the test role.
ALTER DEFAULT PRIVILEGES FOR ROLE dcms IN SCHEMA tenancy, plugins, cms, media, sites, search, analytics, chat, visitors, ai
