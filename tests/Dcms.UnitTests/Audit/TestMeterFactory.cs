...
///
/// <para>Nothing collects from these meters in a unit test; they exist so the code under
/// test can count without the test having to stand up the metrics hosting stack.</para>
/// </summary>
